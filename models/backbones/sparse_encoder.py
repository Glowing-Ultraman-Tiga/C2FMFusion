...
class SparseEncoder(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_size, **kwargs):
        ...
        for encoder_layer in self.encoder_layers:
            ...
            dense_feat = x.dense()
            N, C, H, W, D = dense_feat.shape
            dense_feat = dense_feat.permute(0, 1, 4, 2, 3).contiguous().view(N, C * D, H, W)
            #print("dense_feat:", dense_feat.shape)
            multi_scale_features.append(dense_feat)
        ...
        multi_scale_features[-1] = spatial_features
        lidar_feats = [multi_scale_features[1], multi_scale_features[3]]
