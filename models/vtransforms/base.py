...
class BaseDepthTransform(BaseTransform):
    ...
    def forward(
        ...
        **kwargs,
        ...
        #cam_feats = self.get_cam_feats(img, depth, mats_dict)
        ...
        #if isinstance(cam_feats, tuple):
        #    cam_feats, depth = cam_feats 
        #    use_depth = True
        #bev_features = []
        #for feat in cam_feats:
        #    bev_feat = self.bev_pool(geom, feat)
        #    print("bev_feat:", bev_feat.shape)
        #    bev_features.append(bev_feat)

        #if use_depth:
        #    return bev_features, depth 
        #else:
        #    return bev_features
