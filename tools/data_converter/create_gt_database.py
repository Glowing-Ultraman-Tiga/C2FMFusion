        ...
        for i in range(num_obj):
            ...
            if (used_classes is None) or names[i] in used_classes:
                db_info = {
                    ...
                    "location": input_dict.get("location", "unknown")
                }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--database-save-path', type=str, default=None)
    parser.add_argument('--db-info-save-path',    type=str, default=None)
    ...
    create_groundtruth_database(
        ...
        database_save_path=args.database_save_path,
        db_info_save_path=args.db_info_save_path,
    )